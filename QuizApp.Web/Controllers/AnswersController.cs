...
namespace QuizApp.Web.Controllers
{
    public class AnswersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,IsCorrect,QuestionId")] Answer answer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,IsCorrect,QuestionId")] Answer answer)
        {
            if (id != answer.Id)
            {
                return NotFound();
